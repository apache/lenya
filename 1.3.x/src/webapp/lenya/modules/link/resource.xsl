...
<h1><xsl:value-of select="$publicationname"/>&#160;<i18n:text>Link</i18n:text>&#160;<i18n:text>Resource</i18n:text>&#160;<xsl:value-of select="@unid"/></h1>
...
<xsl:element name="input">
<xsl:attribute name="type">text</xsl:attribute>
<xsl:attribute name="name"><xsl:value-of select="@language"/>.href</xsl:attribute>
<xsl:attribute name="size">60</xsl:attribute>
<xsl:attribute name="value"><xsl:value-of select="revision[@revision= $edit]/@href"/></xsl:attribute>
</xsl:element>
</td>
</tr>
<tr>
