...
public class Notifier extends ParameterWrapper {
   ...
   public void sendNotification(TaskParameters taskParameters) throws ExecutionException {
      if(getMap().isEmpty()){
         ...
         String[] keys = {Task.PARAMETER_PUBLICATION_ID, Task.PARAMETER_CONTEXT_PREFIX, Task.PARAMETER_SERVER_PORT, Task.PARAMETER_SERVER_URI, Task.PARAMETER_SERVLET_CONTEXT};
