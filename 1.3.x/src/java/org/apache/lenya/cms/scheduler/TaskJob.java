...
/**
 * A TaskJob is a Job that executes a Task. The task ID is obtained from the <code>task-id</code> request parameter.
 */
public class TaskJob extends ServletJob {
    ...
    */
   protected Map stripPrefixes(Map wrapperMap) throws SchedulerException {
    ...
    *            when something went wrong.
    */
   public JobDataMap createJobData(HttpServletRequest request) throws SchedulerException {
