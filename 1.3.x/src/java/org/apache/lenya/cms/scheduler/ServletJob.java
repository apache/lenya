...
public abstract class ServletJob implements Job {
    ...
    *            when something went wrong.
    */
   public JobDetail load(Element element, String jobGroup, String servletContextPath) throws SchedulerException {
    ...
    * 
    * @param helper
    *           The namespace helper of the document the element shall belong to.
    * @param jobDetail
