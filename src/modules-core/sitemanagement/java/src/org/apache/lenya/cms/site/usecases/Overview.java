    ...
    protected void initParameters() {
        ...
        try {
            ...
            if (doc == null) {
                ...
                setParameter(PARAM_NUMBER_OF_DOCUMENTS, Integer.valueOf(area.getDocuments().length));
                setParameter(PARAM_NUMBER_OF_SITE_NODES, Integer.valueOf(area.getSite().getNodes().length));
            }
            else {
