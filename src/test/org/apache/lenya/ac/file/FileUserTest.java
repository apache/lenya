...
/* $Id: FileUserTest.java 473841 2006-11-12 00:46:38Z gregor $  */
 ...
 * File user test.
 * 
 * @version $Id: FileUserTest.java 473841 2006-11-12 00:46:38Z gregor $
 */
public class FileUserTest extends AccessControlTest {
    ...
    protected FileUserManager getUserManager() throws AccessControlException {
        ...
        FileUserManager manager = FileUserManager.instance(wrapper,
                (FileAccreditableManager) getAccreditableManager(), userTypes, getLogEnabledLogger());
        return manager;
    }
}
