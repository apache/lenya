...
<!-- $Id: search-and-results.xsl 43053 2004-05-26 22:23:37Z gregor $ -->
    ...
    <xsl:template match="search-and-results">
            <div id="body">
                <div class="search-box">
                    <div class="search-box-title">Search <xsl:value-of select="search/publication-name"/></div>
                    <div class="search-box-body">
                        <form>
                            <table class="search-table-noborder">
                                <tr>
                                    <td>Search</td>
                                    <td>
                                        <input type="text" name="queryString" size="60" class="search-form-element">
                                ...
                                <tr>
                                    <td>Sort by</td>
                                    <td>
                                        <select name="sortBy" class="search-form-element">
    ...
    <xsl:template match="configuration">
        <xsl:for-each select="publication">
            ...
            <tr>
                <td>Fields</td>
                <td>
                    <select name="dummy-index-id.fields" class="search-form-element">
                    <!-- TODO: ... -->
                    <!--<select name="{@pid}.fields" class="search-form-element">-->
...
-->
                <table width="90%" cellpadding="4" class="search-table">
                    <tr>
                        <td>&#160;</td>
                        <td>Score</td>
                        <td>Document</td>
