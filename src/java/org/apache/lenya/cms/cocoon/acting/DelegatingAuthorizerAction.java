...
/* $Id: DelegatingAuthorizerAction.java 473841 2006-11-12 00:46:38Z gregor $  */
...
public class DelegatingAuthorizerAction extends AccessControlAction {
    ...
    protected Map doAct(Redirector redirector, SourceResolver resolver, Map objectModel,
        ...
        boolean authorized = getAccessController().authorize(request, handler);
    ...
    public static final String ERRORS = DelegatingAuthorizerAction.class.getName() + ".Errors";

    public static final String HISTORY = DelegatingAuthorizerAction.class.getPackage().getName()
            + ".History";
