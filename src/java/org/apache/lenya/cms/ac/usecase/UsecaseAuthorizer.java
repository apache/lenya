 ...
 * @version $Id: UsecaseAuthorizer.java 473841 2006-11-12 00:46:38Z gregor $
 */
public class UsecaseAuthorizer
    ...
    /**
     * @see org.apache.lenya.ac.Authorizer#authorize(org.apache.cocoon.environment.Request, ErrorHandler)
     */
    public boolean authorize(Request request, ErrorHandler handler) throws AccessControlException {
        ...
        try {
            ...
            if (usecase != null) {
                ...
                if (!authorized) {
                    handler.error("You are not allowed to execute the usecase '" + usecase + "'.");
                }
            } else {
