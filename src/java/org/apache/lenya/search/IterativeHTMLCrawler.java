 ...
 */
  public static void main(String[] args){
    if(args.length != 1){
      System.err.println("Usage: IterativeHTMLCrawler http://127.0.0.1:48080/index.html");
      return;
      }
 
    try{
      new IterativeHTMLCrawler().crawl(new URL(args[0]));
      }
    ...
    while(currentPosition < urlsToCrawl.size()){
      ...
      if(urlsWithinPage != null){
        ...
        while(iterator.hasNext()){
          ...
          System.out.println(".crawl(): "+urlCandidate); 
          if(handleLink(urlCandidate,currentURLPath,urlsToCrawlLowerCase)){
            try{
              URL urlToCrawl=new URL(currentURLPath+"/"+urlCandidate);
 ...
 *
 */
  public boolean handleLink(String url,String currentURLPath,java.util.TreeSet links){
