...
/**
 * The Jing validator code is copied from the JingTransformer by Pier Fumagalli. It would be nice to
 * refactor the JingTransformer code into a separate component and reuse it here.
 * 
 * @see org.apache.cocoon.transformation.JingTransformer
 */
public class JingValidator extends AbstractLogEnabled implements Configurable, Serviceable,
        Disposable, XMLReaderCreator, EntityResolver, org.apache.lenya.xml.Validator {

    /**
     * <p>
     * The {@link SchemaReader} to use for reading RNG schemas.
     * </p>
     */
    private final SchemaReader schemaReader = SAXSchemaReader.getInstance();
    /**
     * <p>
     * The current {@link Stack} of {@link InputSource}s being parsed.
     * </p>
     */
    ...
    /**
     * <p>
     * The {@link ServiceManager} associated with this instance.
     * </p>
     */
    private ServiceManager serviceManager = null;
    /**
     * <p>
     * Cocoon's global {@link EntityResolver} for catalog resolution.
     * </p>
     */
    private EntityResolver entityResolver = null;
    /**
     * <p>
     * Cocoon's global temporary cache {@link Store} for parsed schemas.
     * </p>
     */
    private Store transientStore = null;
    /**
     * <p>
     * The {@link PropertyMap} to use with JING's factories.
     * </p>
     */
    private PropertyMap validatorProperties = null;
    /**
     * <p>
     * A {@link String} for unique IDs stored into caches.
     * </p>
     */
    ...
    /**
     * <p>
     * The {@link InputSource} associated with the current schema.
     * </p>
     */
    private InputSource inputSource = null;
    /**
     * <p>
     * The {@link SourceValidity} associated with the schema.
     * </p>
     */
    private AggregatedValidity sourceValidity = null;
    /**
     * <p>
     * The {@link SourceResolver} to use for resolving URIs.
     * </p>
     */
    ...
    /**
     * <p>
     * Contextualize this component instance specifying its associated {@link ServiceManager}
     * instance.
     * </p>
     * 
     ...
     * <code>&lt;enable-caching&gt;<i>true|false</i>&lt;/enable-caching&gt;</code> indicating
     * whether compiled schema files must be cached in Cocoon's transient store.
     * </p>
     * 
    ...
    /**
     * <p>
     * Dispose of this component instance releasing all previously acquired required instances back
     * to the {@link ServiceManager}.
     * </p>
     */
    public void dispose() {
    ...
    public void validate(InputSource xmlInputSource, InputSource schemaInputSource,
        ...
        try {
            ...
            this.inputSource = resolveEntity(schemaInputSource.getPublicId(),
            ...
            ValidateProperty.ERROR_HANDLER.put(builder, handler);
            ValidateProperty.XML_READER_CREATOR.put(builder, this);
            this.validatorProperties = builder.toPropertyMap();

            ValidationDriver driver = new ValidationDriver(this.validatorProperties, schemaReader);
    ...
    /**
     * <p>
     * Return the unique key to associated with the schema being processed in the scope of the
     * request being processed for caching.
     * </p>
     * 
    ...
    /**
     * <p>
     * Return the {@link SourceValidity} associated with the schema currently being processed in the
     * scope of the request being processed.
     * </p>
     * 
    ...
    /**
     * <p>
     * Resolve an {@link InputSource} from a public ID and/or a system ID.
     * </p>
     * 
     * <p>
     * This method can be called only while a request is being processed (after the
     * {@link #validate(InputSource, InputSource, ErrorHandler)} metod was called but before the
     * {@link #recycle()} method was called) and will resolve URIs against a dynamic {@link Stack}
     * of {@link InputSource}s.
     * </p>
     * 
     * <p>
     * Since <a href="http://www.thaiopensource.com/relaxng/jing.html">JING</a> doesn't offer a
     * complete URI resolution contract, a {@link Stack} is kept for all the sources parsed while
     * reading a schema. Keeping in mind that the last {@link InputSource} pushed in the
     * {@link Stack} can be considered to be the "base URI" for the current resolution, full
     * relative resolution of system IDs can be achieved this way.
     * <p>
     * 
     * <p>
     * Note that this method of resolving URIs by keeping a {@link Stack} of processed URIs is a
     * <i>sort of</i> a hack, but mimics the internal state of <a
     * href="http://www.thaiopensource.com/relaxng/jing.html">JING</a> itself: if URI resolution
     * fails, the {@link Stack} analysis is the first part to look at.
     * </p>
     * 
     * <p>
     * Resolution will use Cocoon's configured {@link EntityResolver} for resolving public IDs, and
     * Cocoon's {@link SourceResolver} to resolve the system IDs and accessing the underlying byte
    ...
    /**
     * <p>
     * Create an {@link XMLReader} instance that can be used by <a
     * href="http://www.thaiopensource.com/relaxng/jing.html">JING</a> for parsing schemas.
     * </p>
     * 
     * <p>
     * The returned {@link XMLReader} will keep track of populating/clearing the {@link Stack} of
     * {@link InputSource}s kept for URI resolution as explained in the description of the
     * {@link #resolveEntity(String, String)} method.
     * </p>
     * 
    ...
    /**
     * <p>
     * Return a new {@link Validator} instance either parsing a schema or retrieving it from
     * Cocoon's transient store (if caching is enabled).
     * </p>
     */
    private Validator newValidator() throws SAXException, IOException, ProcessingException {
    ...
    /**
     * <p>
     * Return a new {@link Schema} instance parsing it from the source specified in the
     * {@link #setup(SourceResolver, Map, String, Parameters)} method.
     * </p>
     */
    private Schema newSchema() throws SAXException, IOException, ProcessingException {
        try {
            return this.schemaReader.createSchema(this.inputSource, this.validatorProperties);
    ...
    /**
     * <p>
     * A trivial {@link XMLReader} implementation populating and clearing the {@link Stack} of
     * {@link InputSource}s for URI resolution.
     * </p>
     */
    private static final class Reader implements XMLReader {

        private final XMLReader reader;
        private final JingValidator validator;

        private Reader(JingValidator validator) throws SAXException {
            /*
             * We have to look up the XMLReader using JAXP or SAX, as the SAXParser supplied by
             * Avalon/Excalibur does not seem to work with JING.
             */
            try {
                ...
                this.reader.setEntityResolver(validator);
        ...
        public void setProperty(String property, Object value) throws SAXNotRecognizedException,
                SAXNotSupportedException {
        ...
        public void parse(InputSource source) throws IOException, SAXException {
            this.validator.parsedSourceStack.push(source);
            try {
                this.reader.parse(source);
            } catch (IOException e) {
                throw e;
            }
            this.validator.parsedSourceStack.pop();
        }
    ...
    /**
     * <p>
     * An extremely simple bean associating a {@link Schema} with its {@link AggregatedValidity}.
     * </p>
     */
