...
<xsl:stylesheet
  ...
  <xsl:template match="user">
    <div class="lenya-box">
      <div class="lenya-box-title">Add User</div>
      <div class="lenya-box-body">
        <form action="" method="GET">
          <input name="lenya.usecase" type="hidden" value="user-add"/>
          <input name="lenya.step" type="hidden" value="add"/>
          <xsl:attribute name="action"/>
          <table class="lenya-table-noborder">
            <tr>
              <td class="lenya-entry-caption">User ID</td>
              <td>
                <input class="lenya-form-element" name="user-id" type="text">
            ...
            <tr>
              <td class="lenya-entry-caption">Email</td>
              <td>
            ...
            <tr>
              <td class="lenya-entry-caption">Group</td>
              <td>
