...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="upload-image">
    <h1>Upload Image</h1>
    <p>Please browse for an image (gif, jpeg, png) on your harddisk. If you enter an identifier it will be used as filename. Entering metadata is optional.</p>
	...
	<tr>
	  <td>Creator (Author)&#160;</td><td><input type="text" name="creator" size="40"/></td>
	</tr>
	<tr>
	  <td>Image Title&#160;</td><td><input type="text" name="title" size="40"/></td>
	</tr>
	<tr>
	  <td>Subject (Keywords)&#160;</td><td><input type="text" name="subject" size="40"/></td>
	</tr>
	<tr>
	  <td>Image Description&#160;</td><td><input type="text" name="description" size="40"/></td>
	</tr>
	<tr>
