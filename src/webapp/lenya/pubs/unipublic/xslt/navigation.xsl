...
<xsl:template match="MainNavigation" xmlns:xi="http://www.w3.org/2001/XInclude">
  <table border="0" cellpadding="0" cellspacing="0" width="135" align="right">
    <xsl:for-each select="Channels/Channel">
          <tr>
            <td align="right"><img height="21" width="120" src="{$img-unipub}/t_{@name}.gif" border="0" alt="{@name}"/></td>
          </tr>                                                                                                                             
