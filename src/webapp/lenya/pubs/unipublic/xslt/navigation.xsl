            ...
            <tr>
              <xsl:choose>
                <xsl:when test="@highlighted='true'">
                  <td><a href="{$unipublic}/{../../@name}/{@id}/"><img height="25" src="{$img-unipub}/nav_light_{@id}.gif" border="0" name="{@id}" alt="{$sectiontext}" width="115"/></a></td>
                </xsl:when>
                <xsl:otherwise>
                  <td><a href="{$unipublic}/{../../@name}/{@id}/"><img height="25" src="{$img-unipub}/nav_{@id}.gif" border="0" name="{@id}" alt="{$sectiontext}" width="115"/></a></td>
                </xsl:otherwise>
              </xsl:choose>
            </tr>
            <tr>
