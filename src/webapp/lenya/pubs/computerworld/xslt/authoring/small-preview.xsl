...
<xsl:template match="small-preview">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="140">
		...
		<tr>
    		<td width="52" valign="top" align="center">	<br/>
	<a href="index.html?usecase=uploadimage&amp;step=showscreen&amp;documentid=small-preview.xml&amp;xpath=/small-preview/item"><img src="/images/wyona/cms/util/reddot.gif" alt="Insert Image" border="0"/></a>
	<br/>
<a href="magazine/"><img border="0" src="/img/{media/media-reference/@source}" width="42" height="42" alt="{media/media-reference/@alternate-text}" /></a></td>
