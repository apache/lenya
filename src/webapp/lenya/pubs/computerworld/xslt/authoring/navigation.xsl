...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="sitetree">
		<table border="0" cellpadding="0" cellspacing="0" width="140">
			<tr>
				<td colspan="2">
					<img border="0" src="/img/layout/trans1x1.gif" width="1" height="10"/>
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<img border="0" src="/img/layout/aktuell.gif" width="140" height="18" alt="Aktuell"/>
				</td>
			</tr>
			<xsl:for-each select="block[@id = 'aktuell']/node">
				...
				<tr>
					<td width="16" height="16" valign="middle" align="right">
						<a href="">
							<img border="0" src="/img/layout/arrow-black.gif" width="9" height="7" alt="»"/>
						</a>
					</td>
					<td width="124">
						<xsl:choose>
			...
			<tr>
				<td colspan="2">
					<img border="0" src="/img/layout/infos.gif" width="140" height="18" alt="Infos"/>
				</td>
			</tr>
			...
			<tr>
				<td colspan="2">
					<img border="0" src="/img/layout/verlag.gif" width="140" height="18" alt="Verlag"/>
				</td>
			</tr>
			...
			<tr>
				<td colspan="2">
					<a href="magazine/">
						<img border="0" src="/img/layout/magazine.gif" width="140" height="18" alt="Magazine"/>
					</a>
				</td>
			</tr>
			<tr>
