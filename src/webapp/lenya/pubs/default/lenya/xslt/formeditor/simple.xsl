...
<node name="Title" select="/simple:simple-document/lenya:meta/dc:title[@tagID='{lenya:meta/dc:title/@tagID}']">
...
<node name="Description" select="/simple:simple-document/lenya:meta/dc:description[@tagID='{lenya:meta/dc:description/@tagID}']">
