...
<tr>
  ...
  <td><textarea name="&lt;xupdate:update select=&quot;/system/description[@tagID='{description/@tagID}']&quot;&gt;" cols="40" rows="5"><xsl:apply-templates select="description/node()" mode="mixedcontent"/></textarea></td>
</tr>
