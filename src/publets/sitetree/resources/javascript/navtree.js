...
NavRoot.prototype.loadInitialTree = function(area, documentid) {
  var url = CONTEXT_PREFIX + '/' + PUBLICATION_ID + PIPELINE_PATH + '?area='+area+'&documentid='+documentid+'&language='+CHOSEN_LANGUAGE+'&initial=true&areas='+ALL_AREAS+'&lenya.publet=sitetree';  
...
NavNode.prototype.loadSubTree = function(handler) 
{
  ...
  var url = CONTEXT_PREFIX + '/' + PUBLICATION_ID + PIPELINE_PATH + '?area='+area+'&documentid='+documentid+'&language='+CHOSEN_LANGUAGE+'&areas='+ALL_AREAS+'&lenya.publet=sitetree';
